...
#Create a plot with type=lines
plot(Z_read_data$Timestamp ,Z_read_data$Global_active_power, type = "l" , ylab = "Global Active Power (Killowatts)", 
     xlab = "")
dev.copy(png,"plot2.png", width =1024 , height = 780)
##png 
##4 
dev.off()
##RStudioGD 
